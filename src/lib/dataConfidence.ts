...
import { provenanceTrust, benfordConformity, benfordRangeTooNarrow, leadingDigitHistogram, type ConfidenceTxn } from './transactionSignals';

// Re-exported for back-compat: every other consumer in this codebase imports these (and the
// ConfidenceTxn type) from this file, not from transactionSignals.ts directly. Moved out to
// break a require cycle (UI/UX P3.19)  this file needs fraudFeatures.ts, and fraudFeatures.ts
// used to need these back from here.
export { provenanceTrust, benfordConformity, leadingDigitHistogram, type ConfidenceTxn };

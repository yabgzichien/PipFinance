...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  shopping:       ['shopping', 'shop', 'retail', 'store', 'fashion', 'clothing', 'apparel', 'furniture', 'appliance', 'lazada', 'shopee', 'amazon', 'zalora', 'ikea', 'h&m', 'uniqlo', 'mall', 'boutique', 'outlet', 'purchase'],
  ...
  'phone-bill':   ['phone bill', 'phone', 'mobile', 'telco', 'prepaid', 'postpaid', 'unifi', 'maxis', 'celcom', 'digi', 'umobile', 'yes', 'astro', 'communication', 'internet', 'broadband', 'telecom'],
  ...
  other:          ['other', 'miscellaneous', 'misc', 'unknown', 'postage', 'health', 'medical', 'hospital', 'clinic', 'klinik', 'pharmacy', 'doctor', 'dentist', 'medicine', 'guardian', 'watson', 'lab', 'optical', 'education', 'school', 'sekolah', 'tuition', 'tadika', 'nursery', 'childcare', 'college', 'university', 'course', 'exam', 'textbook', 'stationery', 'yuran', 'household', 'toiletries', 'personal care', 'salon', 'barber', 'laundry'],

...
const styles = StyleSheet.create({
  ...
  baseKicker: { fontFamily: uiFont(600), fontSize: 10, letterSpacing: 1, color: colors.ink3, marginBottom: 8 },
  ...
  baseScoreDenom: { fontFamily: uiFont(500), fontSize: 13, color: colors.ink3 },
  ...
  sectionLabel: { fontFamily: uiFont(600), fontSize: 10, letterSpacing: 1, color: colors.ink3, marginTop: 20, marginBottom: 8 },
  ...
  deltaFrom: { fontFamily: numFont(600), fontSize: 12.5, color: colors.ink3 },
  deltaTo: { fontFamily: numFont(700), fontSize: 13, color: colors.ink },
  flatNote: { fontFamily: uiFont(500), fontSize: 11.5, color: colors.ink3, marginTop: 8, fontStyle: 'italic' },
  ...
  blockedNote: { fontFamily: uiFont(500), fontSize: 12, color: colors.ink3, marginTop: 4, lineHeight: 17 },
});

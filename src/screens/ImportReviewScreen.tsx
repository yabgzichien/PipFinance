...
const styles = StyleSheet.create({
  ...
  meta: { fontFamily: uiFont(500), fontSize: 12, color: colors.ink3, flexShrink: 1 },
  dupTag: { fontFamily: uiFont(700), fontSize: 10.5, color: '#d98a00', backgroundColor: '#fbf0d8', paddingHorizontal: 6, paddingVertical: 1, borderRadius: 6, overflow: 'hidden' },

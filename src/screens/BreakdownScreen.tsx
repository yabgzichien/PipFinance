...
const styles = StyleSheet.create({
  ...
  pieEyebrow: { fontFamily: uiFont(700), fontSize: 11, letterSpacing: 1, textTransform: 'uppercase', color: colors.ink3, marginBottom: 2 },
  ...
  secondary: { fontFamily: uiFont(500), fontSize: 11.5, color: colors.ink3, marginTop: 1 },

...
const styles = StyleSheet.create({
  ...
  detectedSub: { fontFamily: uiFont(500), fontSize: 12, color: colors.ink3, marginTop: 2 },
  ...
  hint: { fontFamily: uiFont(500), fontSize: 11.5, color: colors.ink3, marginTop: 8 },
  ...
  sectionLabel: { fontFamily: uiFont(700), fontSize: 9.5, color: colors.ink3, letterSpacing: 0.06, textTransform: 'uppercase', padding: 14, paddingBottom: 6 },

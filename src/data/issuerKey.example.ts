...
//   node tools/demoPassport/generate.js       (re-signs the console's sample passport)
...
// ISSUER_PUBLIC_KEY_HEX, and paste the SAMPLE_CODE line generate.js prints into
// LenderConsole/app/tokens.ts (that copy is manual — see its own comment).
// generateApplicants.js writes LenderConsole/app/demoApplicants.ts directly.
// The values below are placeholders and will not verify against anything.

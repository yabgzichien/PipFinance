...
# Pip Instagram Post Skill (`ig_post_skills.md`)

This skill defines the complete standard for designing, rendering, and copywriting Instagram carousel posts for Pip Finance.
